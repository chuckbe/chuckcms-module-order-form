...
$(document).ready(function() {
	...
	$('body').on('click', '.cof_btnAddProductToCart', function (event) {
		...
		console.log('cof_btnAddProductToCart :: ', product_id, current_price, quantity, product_name, total_price);
	...
	function updateProductListItemAttributes(selector, product_id, product_name, attribute_name, product_options_json, product_extras_json, product_subproducts_json, quantity, current_price, total_price)
	{
		...
		$(''+selector+'').find('.cof_cartProductListItemSubproducts:not(:first)').remove();
		$(''+selector+'').find('.cof_cartProductListItemSubproducts:first').removeClass('d-block').addClass('d-none');
	...
	function checkForProductsInUrl() {
		...
		if (searchParams.has('addToCart')) {
			...
			selector = '.cof_cartProductListItem:first';
			updateProductListItemAttributes(selector, product_id, product_name, attribute_name, searchParams.get('options'), JSON.stringify([]), JSON.stringify([]), 1, current_price, total_price);
