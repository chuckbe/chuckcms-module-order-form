							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="dd/mm/yyyy,dd/mm/yyyy,..." name="dates_enabled" value="{{ old('dates_enabled', (is_array($product->dates_enabled) ? implode(',',$product->dates_enabled) : $product->dates_enabled)) }}">
									</div>
								</div>
							</div>
							<hr>
