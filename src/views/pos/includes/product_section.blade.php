                        ...
                        @foreach ($products as $product)
                            @if($product->json['category'] == $category->id && $product->is_pos_available == true)
                                <div 
                                    ...
                                    data-product-category-id="{{ $product->getJson('category') }}" 
                                    data-product-name="{{ $product->getJson('name.nl') }}" 
                                    data-q="{{ http_build_query($product->getJson('quantity'),'',',') }}" 
                                    data-vat-delivery="{{ $product->json['price']['vat_delivery'] }}" 
                                    data-vat-takeout="{{ $product->json['price']['vat_takeout'] }}" 
                                    data-vat-on-the-spot="{{ $product->json['price']['vat_on_the_spot'] }}" 
                                    ...
                                    @endif
                                    @if(array_key_exists('subproducts', $product->json)) 
                                    data-product-subproducts="{{ json_encode($product->json['subproducts']) }}" 
                                    @endif
                                >
